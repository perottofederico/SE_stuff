 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://soapws.softeng.sapienza.it/", wsdlLocation = "http://0.0.0.0:8081/WSInterface?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://0.0.0.0:8081/WSInterface?wsdl");
